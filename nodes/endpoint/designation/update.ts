...
export async function updateDesignation(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
  ...
  const responseData = await ApiRequest.call(this, 'PUT', `/designation/${designationId}`, body);
  ...
  // Return simplified response for updated designation
