...
export async function updateObjective(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const responseData = await ApiRequest.call(this, 'PUT', `/objectives/${objectiveId}`, body);
