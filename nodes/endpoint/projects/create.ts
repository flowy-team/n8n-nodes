...
export async function createProject(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	...
	const responseData = await ApiRequest.call(this, 'POST', '/projects', body);
