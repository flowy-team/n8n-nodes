...
export async function updatePerformanceCycle(
  ...
  // Get all parameters directly from the node
  ...
  const responseData = await ApiRequest.call(this, 'PUT', `/performance-cycle/${performanceCycleId}`, body);
...
export default updatePerformanceCycle;
